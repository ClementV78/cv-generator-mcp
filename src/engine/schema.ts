    ...
    header: {
      ...
      properties: {
        ...
        photoZoom: {
          ...
          minimum: 80,
          maximum: 180,
          description: "Zoom de la photo en pourcentage dans le cadre circulaire.",
        },
        headline: {
          type: "string",
        ...
        residence: {
          type: "string",
          description: "Lieu de residence affiche dans les contacts.",
        },
        nationality: {
          type: "string",
          description: "Nationalite affichee dans les contacts (ex: FR ou FR 🇫🇷).",
        },
        location: {
          type: "string",
          description: "Champ legacy de localisation courte. Utilise comme fallback si residence est vide.",
        },
        email: { type: "string", description: "Adresse email de contact." },
        phone: { type: "string", description: "Numero de telephone de contact." },
        linkedin: { type: "string", description: "Lien LinkedIn (sans https possible)." },
        github: { type: "string", description: "Lien GitHub (sans https possible)." },
        availabilityText: {
          type: "string",
    ...
    experiences: {
      ...
      items: {
        ...
        properties: {
          ...
          summary: {
            type: "string",
            description: "Phrase d'introduction narrative affichee avant les bullets.",
          },
          bullets: {
            type: "array",
            items: { $ref: "#/$defs/textItem" },
