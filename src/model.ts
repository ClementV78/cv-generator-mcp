...
export const normalizeCvData = (input: unknown): CvData => {
  ...
  return {
    header: {
      ...
      residence: asString(header.residence, asString(header.location, "France")),
      nationality: asString(header.nationality, ""),
      location: asString(header.location, asString(header.residence, "France")),
